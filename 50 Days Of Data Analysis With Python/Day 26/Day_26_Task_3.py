# Write code to access the total costs of jackets (using the .loc attribute).
...
# Access total costs of jackets using .loc
jacket_costs = df.loc[df["Product Name"] == "Jacket", "Cost"].sum()

print(f"Total Costs of Jackets: ${jacket_costs:.2f}")
