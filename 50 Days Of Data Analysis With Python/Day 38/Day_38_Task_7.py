...
# Find the two cities with the least revenue
city_revenue = df.groupby('City')['Final Price'].sum()

lowest_revenue_cities = city_revenue.nsmallest(2)

print("\nTwo cities with the least revenue:")
print(lowest_revenue_cities)