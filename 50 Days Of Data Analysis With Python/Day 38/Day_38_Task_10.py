...
# Find the total revenue of the business
total_revenue = df['Final Price'].sum()

print("\nTotal revenue of the car rental business:", total_revenue)

# Calculate total revenue if no discount was given
# Assuming:
# Original Price = Final Price + Discount

revenue_no_discount = (df['Final Price'] + df['Discount']).sum()

print("\nTotal revenue if no discount was given:", revenue_no_discount)