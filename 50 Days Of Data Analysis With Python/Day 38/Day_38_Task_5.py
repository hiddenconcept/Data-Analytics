...
# Find which car type brought in the most money
car_type_revenue = df.groupby('Car Type')['Final Price'].sum()

top_car_type = car_type_revenue.idxmax()
top_revenue = car_type_revenue.max()

print(f"\nCar type with the highest revenue: {top_car_type}")
