...
#4 Calculate the "Total_Cost" column and insert it in the DataFrame between the "Quantity" and "Total Revenue." columns.
#Use the pandas insert() function.
...
df.insert(4, 'Total_Cost', total_cost)  # index 4 = just before Total Revenue
